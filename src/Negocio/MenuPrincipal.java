...
public class MenuPrincipal {
    ...
    public Televisor pedirTelevisor() {
        ...
        switch (usrOp) {
            case 1:
                tv.setTipo(TipoTelevisor.PLASMA);
                break;
            case 2:
                tv.setTipo(TipoTelevisor.LED);
                break;
            case 3:
                tv.setTipo(TipoTelevisor.LCD);
                break;
            case 4:
                tv.setTipo(TipoTelevisor.OLED);
                break;
            default:
    ...
    private void menuClientes() {
        ...
        try {
            ...
            do {
                ...
                if (opcionClientes == 1) {
                    System.out.println("1.Introducir Mayorista\n2.Introducir Particular");
                    int usrOp = sc.nextInt();
                    switch (usrOp) {
                        case 1:
                            introducirMayorista();
    ...
    private void introducirMayorista() {
        Scanner sc = new Scanner(System.in);
    ...
    private void introducirParticular() {
